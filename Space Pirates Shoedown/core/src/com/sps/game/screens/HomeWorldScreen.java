...
public class HomeWorldScreen extends PlayScreen {
    ...
    public HomeWorldScreen(SpacePiratesShoedown game, Vector2 chosenMap, int px, int py) {
        ...
        if(currentMapState.equals(MapFactory.MapType.HomeWorldMap1)) {
            ...
            npc.add(new InteractiveNPCMoving(768, 1216, MapFactory.MapType.HomeWorldMap1, batch, "", "Bob"));
            npc.add(new InteractiveNPCMoving(832, 576, MapFactory.MapType.HomeWorldMap1, batch,  "","ThirdNPC"));//need to make them first talk then they can move away
            npc.add(new InteractiveNPCMoving(768, 896, MapFactory.MapType.HomeWorldMap1, batch, "","BusinessNPC"));
            npc.add(new InteractiveNPCMoving(224, 192, MapFactory.MapType.HomeWorldMap1, batch, "", "FirstNPC"));
            npc.add(new InteractiveNPCMoving(736, 608, MapFactory.MapType.HomeWorldMap1, batch, "", "AnotherNPC"));
