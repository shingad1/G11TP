...
<tileset version="1.2" tiledversion="1.2.0" name="deco-med" tilewidth="32" tileheight="32" tilecount="1024" columns="16">
 <image source="decorations-medieval.png" width="512" height="2048"/>
 <terraintypes>
  <terrain name="Table" tile="561"/>
  <terrain name="Table Covered" tile="497"/>
 </terraintypes>
 <tile id="13">
  <animation>
 ...
 <tile id="480" terrain=",,,1"/>
 <tile id="481" terrain=",,1,1"/>
 <tile id="482" terrain=",,1,"/>
 <tile id="496" terrain=",1,,1"/>
 <tile id="497" terrain="1,1,1,1"/>
 <tile id="498" terrain="1,,1,"/>
 <tile id="512" terrain=",1,,"/>
 <tile id="513" terrain="1,1,,"/>
 <tile id="514" terrain="1,,,"/>
 <tile id="544" terrain=",,,0"/>
 <tile id="545" terrain=",,0,0"/>
 <tile id="546" terrain=",,0,"/>
 <tile id="560" terrain=",0,,0"/>
 <tile id="561" terrain="0,0,0,0"/>
 <tile id="562" terrain="0,,0,"/>
 <tile id="576" terrain=",0,,"/>
